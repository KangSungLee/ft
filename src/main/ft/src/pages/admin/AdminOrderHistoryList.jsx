                    ...
                    <TableRow key={index}>
                      <TableCell align="center" style={{ borderRight: '1px solid rgba(224, 224, 224, 1)' }}>
                        <img
                          ...
                          onClick={() => { navigate(`/ft/item/detail/${order.iid}`) }}
                        />
                      </TableCell>
                      <TableCell align="center" style={{ cursor: 'pointer', borderRight: '1px solid rgba(224, 224, 224, 1)' }} onClick={() => { navigate(`/ft/item/detail/${order.iid}`) }}>
